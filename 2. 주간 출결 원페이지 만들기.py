...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        try:
            parsed = parse_date_arg(date_arg)   # 20260831 / 2026-08-31 둘 다
            ...
            print("[오류] 입력된 날짜 형식이 올바르지 않습니다 (20260831 또는 2026-08-31). 기본 주간으로 진행합니다.")
    else:
        print("-> 추가 명령줄 인자가 없어 기본 주간으로 진행합니다. (원하는 주간 지정 방법: python 스크립트명 20260831)")
